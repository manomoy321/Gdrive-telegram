...
async def media_streamer(channel: int, message_id: int, file_name: str, request):
    ...
    # Use premium client if downloading from "me" (Saved Messages)
    premium_req = True if channel == "me" else False
    faster_client = get_client(premium_required=premium_req)
